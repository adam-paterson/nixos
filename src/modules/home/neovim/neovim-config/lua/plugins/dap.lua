...
return {
  {
    ...
    config = function()
      ...
      for name, sign in pairs({
        Stopped = { text = "", texthl = "DiagnosticWarn", linehl = "DapStoppedLine", numhl = "DapStoppedLine" },
        ...
        vim.fn.sign_define(
          "Dap" .. name,
          { text = sign[1], texthl = sign.texthl or nil, linehl = sign.linehl or nil, numhl = sign.numhl or nil }
        )
      end
    end,
  },
